        ...
        el.innerHTML = `
            ...
            <div class="swipe-header">
                ...
                <div class="swipe-actions">
                    <button class="anima-control swipe-favorite" id="anima-swipe-favorite" title="Toggle favorite">Favorite</button>
                    <select class="anima-control swipe-category" id="anima-swipe-category" title="Save to favorite category"></select>
                    <button class="anima-control anima-control-icon swipe-close" id="anima-swipe-close" title="Close">&#10005;</button>
                </div>
            </div>
